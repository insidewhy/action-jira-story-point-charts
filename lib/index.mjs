...
var AVAILABLE_CHARTS = /* @__PURE__ */ new Set([...DEFAULT_CHARTS, "velocity-by-developer"]);
...
async function runChartBot(options) {
  ...
  const allCharts = /* @__PURE__ */ new Map([
    ...
    [
      ...
      async () => {
        const weeklyPointBuckets = getWeeklyPointBuckets();
        return weeklyPointBuckets ? makeVelocityByDeveloperChart(issues, WEEK_IN_MSECS, options) : void 0;
      }
    ]
  ]);
