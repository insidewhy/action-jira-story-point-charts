...
This option is needed to support the `daily-work-item-changes` and `weekly-work-item-changes` charts and will also improve the metrics generated by the `with-daily-description` and `with-weekly-description` textual reports.
